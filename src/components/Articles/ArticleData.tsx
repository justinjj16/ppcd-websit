  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          We cannot continue to look at things the way we
          always have. Here are five commitments I hope
          we can seriously consider and commitied to:
        </p>
        <div className="bg-cream dark:bg-yellow justify-center flex flex-col text-center p-4 rounded-2xl sm:w-1/2 mx-auto my-8">
          <h3 className="text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">1</h3>
          <p className="text-base font-medium leading-relaxed text-black dark:text-white sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">I will help my church shift from “serve us” toservice.</p>
        </div>
        <p className="mb-4 indent-14 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          ...
          There’s no question that a church ought to meet
          your needs.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          But I have found that when I am focused on
          having my needs met, then I most likely to gripe
          and grumble. That’s when I am most likely to be
          miserable and not grow. But when I shift from
          serve us to service, I find my needs miraculously
          being met. I grow!
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="italic mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">Key question: What will I do to be mobilized to serve in some area of brokenness in 2024 and beyond?</p>

        <div className="bg-cream dark:bg-yellow justify-center flex flex-col text-center p-4 rounded-2xl sm:w-1/2 mx-auto my-8">
          <h3 className="text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">2</h3>
          <p className="text-base font-medium leading-relaxed text-black dark:text-white sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">I will help our church shift from impressing from a distance to impacting up close.</p>
        </div>
        <p className="mb-8 indent-14 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Acts 2:42-47: They were continually devoting themselves to the apostles’ teaching and to fellowship, to the breaking of bread and to prayer. Everyone kept feeling a sense of
          awe… And all those who had believed were together and had all things in common… Day by day… breaking bread from house to house, they were taking their meals together
          with gladness and sincerity of heart, praising God and having favor with all the people. And the Lord was adding to their number day by day those who were being saved. We want to see an increasing percentage of people here involved in the fellowship and small groups.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          What role do I need to play to strengthen
          and edify my fellow believers.
        </p>
        <p className="italic mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">Key question: What will I do to strengthen my involvement and commitment to the church in 2024 and beyond?</p>
        <div className="bg-cream dark:bg-yellow justify-center flex flex-col text-center p-4 rounded-2xl sm:w-1/2 mx-auto my-8">
          <h3 className="text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">3</h3>
          <p className="text-base font-medium leading-relaxed text-black dark:text-white sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">I will help our church from watching the service to worshiping the Savior.</p>
        </div>
        <p className="mb-8 indent-14 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Psalms 13:6 I will sing to the LORD, Because
          He has dealt bountifully with me.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Psalms 33:1 Sing for joy in the LORD, O you
          righteous ones; Praise is becoming to the
          upright.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Psalms 34:1 I’ll bless the Lord at all times, his
          praise shall continually be in my mouth.
          Verse 3 Oh, magnify the Lord with me and let
          us exalt his name together. Verse 8 Oh taste
          and see that the Lord is good.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Psalms 104:33 I will sing to the LORD as long
          as I live; I will sing praise to my God while I
          have my being.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Never forget. You aren’t the audience. God is.
          You’re not here to watch. You’re here to
          worship! God is the audience. And believe it
          or not, you are in the choir. Worship is all
          about him and not on us
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          We have to make a conscious decision to get
          close to God week after week. We need to be
          intentional in the worship. Let’s forget about
          ourselves and concentrate on him and
          worship him.
        </p>
        <p className="italic mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Key question: How will I engage in worship
          more passionately since I now know that God
          Himself is the audience? Decide not to be
          spectator anymore and get involved in the
          worship.
        </p>
        <div className="bg-cream dark:bg-yellow justify-center flex flex-col text-center p-4 rounded-2xl sm:w-1/2 mx-auto my-8">
          <h3 className="text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">4</h3>
          <p className="text-base font-medium leading-relaxed text-black dark:text-white sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">I will help our church shift from a comfortmindset to a combat mindset.</p>
        </div>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          I’m not talking about conflict with other
          followers of Christ. I’m not talking about
          conflict within you or family or circle of
          friends. What I am talking about is conflict in
          a spiritual sense.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Ephesians 6:12 Our struggle is not against
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          ...
          writes, “Very few people think that we are in
          a war that is greater than WWII, or any
          imaginable nuclear war. Few reckon that
          Satan is a much worse enemy than any
          earthly foe or realize that the conflict is not
          restricted to one global theatre but is in every town and city in the world. Who
          considers that the casualties of this war do
          not merely lose an arm or an eye or an
          earthly life, but lose everything, even their
          own soul and enter a hell of everlasting
          torment?”
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          When we get to heaven God is going to ask
          us 2 questions.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
        ...
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          The answer to the first question is because of
          the shed blood of Jesus Christ who is my Lord
          and Savior. It’s the second question that
          always gnawed at me over the past several
          years. “Who did you bring with you?”
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Are you a casual follower of Christ or a
          committed follower of Christ?
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          The heartbeat of God is soul winning. God
          has only one son and he send his only one
          son as a missionary to this world.
        </p>
        <p className="italic mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">Key question: How will I live differently as a
warrior for Jesus in 2024 and beyond?</p>
        <div className="bg-cream dark:bg-yellow justify-center flex flex-col text-center p-4 rounded-2xl sm:w-1/2 mx-auto my-8">
          <h3 className="text-xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight">5</h3>
          <p className="text-base font-medium leading-relaxed text-black dark:text-white sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">I will help our church shift from a selfish mindset to the mind of Christ.</p>
        </div>
        <p className="mb-4 indent-14 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Mind of Christ – Philippians 2:5-8 In your
          relationships with one another, have the
          same mind set as Christ Jesus. (NIV)
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          1 Corinthians 2:16 says, “‘For who has known
          the mind of the Lord that he may instruct
          him?’ But we have the mind of Christ.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Having the mind of Christ means we “look at life
          from our Savior’s point of view, having His values
          and desires in mind. It means to think God’s
          thoughts and not to think as the world thinks.” It
          is a shared perspective of humility, compassion,
          and dependence on God.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          True revival is when God transforms our lives.
          Transforming from our desires to His, from our
          selfish motives to His selfless plans.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          The root cause of all problem is our selfish
          ambitions.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          We are created as inter dependent, not intended
          to be in isolation. We become self-dependent
          and moved away from the plan of God.
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          This is “the mind of Christ,” an attitude that says,
          “I cannot keep my privileges for myself, I must
          use them for others; and to do this, I will gladly lay them aside and pay whatever price is
          necessary.”
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          More than twenty times in the New Testament,
          God instructs us how to live with “one another.”
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          We are to prefer one another (Rom. 12:10), edify
          one another (1 Thess. 5:11), and bear each
          other’s burdens (Gal. 6:2). We should not judge
          one another (Rom. 14:13) but rather admonish
          one another (Rom. 15:14).
        </p>
        <p className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          Others is the key word in the vocabulary of the
          Christian who exercises the mind of Christ
        </p>
        <p className="italic mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">Key Question: How will I live differently, moving
        from selfish mindset to the mind of Christ,
        transforming my desires to the plan and purpose of my Master in 2024 and beyond.</p>
        <div className="">
          <p className="text-center mt-16 mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          ...
          <ul className="list-disc">
            <li className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed "> To better love the broken, I must shift from “serve us” to service.</li>
            <li className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">To better love fellow believers, I must shift from impressing to impacting.</li>
            <li className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed"> To better love the Lord, I must shift from watching to worshiping.</li>
            <li className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">To better love the lost, I must shift from comfort to combat.</li>
            <li className="mb-4 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed"> To better serve the Master, I must shift from selfish mindset toe the mind of Christ.</li>
          </ul>
        </div>
      </div>
    ),
