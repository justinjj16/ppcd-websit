...
const Header = ({ isLiveNotification }: { isLiveNotification: boolean }) => {
  // Navbar toggle
  ...
  return (
    <>
      <header
        className={`header left-0 ${isLiveNotification && !sticky ? "top-30" : "top-0"} z-40 flex w-full items-center ${sticky
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
                className={`header-logo block w-full ${sticky ? "py-2" : "pt-4"
                  } `}
              >
                <Image
            ...
            <div className="flex w-full items-center justify-end px-4">
              ...
              <div className="flex sm:hidden items-center justify-end pr-16 lg:pr-0">
                <ThemeToggler />
              </div>
        ...
        <div className="sm:flex justify-center hidden">
          <a
            ...
            className="mr-6 flex items-center text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
          >
            <svg
              width="18"
              height="18"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
          >
            <svg
              width="18"
              height="14"
        ...
        <div className="sm:flex items-center justify-end pr-16 lg:pr-0 hidden">
          <ThemeToggler />
        </div>
      </header>
    </>
