...
const Header = ({ isLiveNotification }: { isLiveNotification: boolean }) => {
  ...
  return (
    <>
      <header
        className={`header left-0 ${isLiveNotification && sticky ? "top-0" : "top-30"} z-40 flex w-full items-center ${sticky
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-end px-4">
              ...
              <div className="flex items-center justify-end pr-16 sm:hidden lg:pr-0">
                <ThemeToggler />
              </div>
            </div>
          </div>
