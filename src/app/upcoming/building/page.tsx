...
export const metadata: Metadata = {
  title: "upcoming Building | Philadelphia Pentecostal Church of Dallas",
  description: "upcoming Building | Philadelphia Pentecostal Church of Dallas",
};
    ...
    <PublicLayout>
      ...
      <section id="building" className="py-16 md:py-20 lg:py-28">
        <div className="container">
          ...
          <div className="my-4">
            <Image
              src="/images/building/building-01.png"
              width={0}
              height={0}
              sizes="100vw"
          ...
          <div className="relative grid gap-4 sm:grid-cols-2 ">
            ...
            />
            <Image
              src="/images/building/building-3.jpeg"
              width={0}
              height={0}
              sizes="100vw"
              style={{ width: "100%", height: "auto" }}
